				...
				<div id="section1" class="mx-auto" style="width: 500px">
					...
					<div class="form-group">
						<label for="uname">Comment:</label> <input type="text"
							...
							required minlength="3" maxlength="15"> <br>
		...
		$(function() {
			...
			$('#button2').click(function() {
				...
				for(var i=0; i<selectNumP; i++) {
					...
					$('#bootWriteList').append('<label>버튼이름</label>' + 
							'<input id=' + 'bootsubject' + i +'' +
							' class="form-control" type="text" name="boot_question">'+
			  				'<label>봇 답변</label>' +
			  				'<textarea id=' + 'bootanswer' + i +'' +
			  				' class="form-control" rows="3" name="boot_answer"></textarea>' +
